...
#-*- coding: utf-8 -*-
"""
爬yande.re原图的爬虫(15禁), 用了高匿代理, IP不会被封
http://bbs.fishc.com/thread-58406-1-1.html
"""
...
opener = urllib.request.build_opener(urllib.request.ProxyHandler({})) # 需自行更改, 不用代理可以直接改成urllib.request.ProxyHandler({})
